...
public class vp_SimpleHUD : MonoBehaviour
{
    ...
    void DrawText()
    {
        ...
        m_MessageColor = Color.Lerp(m_MessageColor, m_InvisibleColor, Time.deltaTime * 0.8f);
        //DrawLabel("", new Vector2(Screen.width - 1150, Screen.height - 625), new Vector2(400, 80), MessageStyle, Color.clear, m_MessageColor, null);
        GUI.color = m_MessageColor;

        GUI.Box(new Rect(800, 475, Screen.width - 1600, Screen.height - 1050), "");
        GUI.color = m_MessageColor;
